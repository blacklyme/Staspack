    ...
    <section id="contact" className="py-24 sm:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-10">
            ...
            <AnimatePresence mode="wait">
              {submitted ? (
                <motion.div
                  ...
                  className="bg-brand-teal/[0.04] rounded-2xl border border-brand-teal/10 p-10 sm:p-12 text-center"
                >
          ...
          {/* Contact info */}
          <FadeIn variant="right" className="lg:col-span-2">
            <div className="space-y-6">
              <div className="p-6 rounded-2xl bg-brand-teal text-white">
